...
- (void)initSubViews
{
    ...
    self.navButton = [[UIButton alloc] initWithFrame:CGRectMake(kPortraitMargin * 2 + kPortraitWidth, kPortraitMargin, kTitleWidth, kTitleHeight)];
    //self.navButton.font = [UIFont boldSystemFontOfSize:14];
    //self.navButton.textColor = [UIColor whiteColor];
    //self.navButton.text = @"titletitletitletitle";
